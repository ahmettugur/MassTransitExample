...
namespace MassTransitExample.Consumer
{
      ...
      public class CustomJsonConsumeContext :
        DeserializerConsumeContext
    {
        ...
        public CustomJsonConsumeContext(JsonSerializer deserializer, ReceiveContext receiveContext, MessageEnvelope envelope)
            : base(receiveContext)
        {
            if (envelope == null)
