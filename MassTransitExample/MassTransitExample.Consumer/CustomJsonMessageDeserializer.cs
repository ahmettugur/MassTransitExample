...
{
    public class CustomJsonMessageDeserializer :
        IMessageDeserializer
    {
        readonly JsonSerializer _deserializer;

        public CustomJsonMessageDeserializer(JsonSerializer deserializer)
        {
        ...
        ConsumeContext IMessageDeserializer.Deserialize(ReceiveContext receiveContext)
        {
            try
            {
                ...
                return new CustomJsonConsumeContext(_deserializer, receiveContext, envelope);
            }
